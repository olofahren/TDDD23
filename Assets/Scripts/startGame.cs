...
public class startGame : MonoBehaviour
{
    ...
    public void StartGame()
    {
        ...
        battleFunctions.AssignStats(1, 1, 1, 10, 10, 2, 1, 1, 1, 1, 10, 0.0f);
        battleFunctions.AssignStats(2, 1, 2, 8, 8, 1, 3, 1, 1, 1, 10, 0.0f);
        battleFunctions.AssignStats(3, 1, 1, 12, 12, 1, 1, 1, 1, 1, 10, 0.0f);
